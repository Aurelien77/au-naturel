...
<link rel="stylesheet" href="../../css/fond.css">
   <div align="center"> 
<form action="model5.php" method="post"> &nbsp;&nbsp; &nbsp;
<span class="titre1"> Ecrivez votre question dans l'encadré puis appuyez sur OK : </span> <br><br><br> <input type="text" name="nom"  /> &nbsp;&nbsp; &nbsp;
