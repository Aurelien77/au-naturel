...
imgB.src = "../../tarots/" + randomFond + ".jpg";
...
var randomFond = Math.floor((Math.random() *21) + 1); // random entre 1 et 200
imgc.src = "../../tarots/" + randomFond + ".jpg";
...
var randomFond = Math.floor((Math.random() *21) + 1); // random entre 1 et 200
imgd.src = "../../tarots/" + randomFond + ".jpg";
...
var randomFond = Math.floor((Math.random() *21) + 1); // random entre 1 et 200
imge.src = "../../tarots/" + randomFond + ".jpg";
...
var randomFond = Math.floor((Math.random() *21) + 1); // random entre 1 et 200
imgf.src = "../../tarots/" + randomFond + ".jpg";
