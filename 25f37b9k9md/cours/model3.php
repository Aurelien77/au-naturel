...
imgA.src = "../../animaux/" + randomCO + ".jpg" ;
imgA.classList.add('maclasse'); 
document.getElementById('container').appendChild(imgA).style.height = "400px"; 
...
imgB.src = "../../animaux/" + randomFond + ".jpg";
document.getElementById('container1').appendChild(imgB).style.height = "400px"; 
...
var randomFond = Math.floor((Math.random() *21) + 1); // random entre 1 et 200
imgc.src = "../../animaux/" + randomFond + ".jpg";
document.getElementById('container2').appendChild(imgc).style.height = "400px"; 
...
var randomFond = Math.floor((Math.random() *21) + 1); // random entre 1 et 200
imgd.src = "../../animaux/" + randomFond + ".jpg";
document.getElementById('container3').appendChild(imgd).style.height = "400px"; 
...
var randomFond = Math.floor((Math.random() *21) + 1); // random entre 1 et 200
imge.src = "../../animaux/" + randomFond + ".jpg";
document.getElementById('container4').appendChild(imge).style.height = "400px"; 
...
var randomFond = Math.floor((Math.random() *21) + 1); // random entre 1 et 200
imgf.src = "../../animaux/" + randomFond + ".jpg";
ocument.getElementById('container5').appendChild(imgf).style.height = "400px"; 
